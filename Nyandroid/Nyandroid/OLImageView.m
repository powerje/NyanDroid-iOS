...
- (void)setRandomImage:(OLImage*)image {
    [self setImage:image];
    randomStartImage = YES;
...
- (void)setAnimatedImage:(OLImage *)animatedImage
{
    ...
    } else if (randomStartImage) {
        self.currentFrameIndex = arc4random() % self.animationImages.count;
    }
}
